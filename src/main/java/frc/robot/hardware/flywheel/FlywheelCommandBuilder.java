...
public class FlywheelCommandBuilder {
	...
	public Command setPower(double power) {
		...
		return new FunctionalCommand(() -> flywheel.setPower(appliedPower), () -> {}, interrupted -> flywheel.stop(), () -> false, flywheel)
			.withName("Set Flywheel power to " + power);
	}

	public Command setVelocity(double velocityRPS) {
		return new FunctionalCommand(() -> flywheel.setPower(), () -> {
			flywheel.setReference(
		...
		}, interrupted -> flywheel.stop(), () -> false, flywheel).withName("Set Flywheel power to " + power);
	}
